...
mc.closing <- replicate(number_of_possible_futures,generate.path())
cat("Median of possible futures =",paste0("£",round(median(mc.closing),3)))
```
]
