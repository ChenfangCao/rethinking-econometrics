...
* Secondly, statistical properties of log returns are **tractable**.
...
* Figure 1.2 shows a time plot of daily simple and log returns of Glencore stock from r first(glendate) to r last(glendate).
...
## Example: Daily T-Bill 3 month rate
