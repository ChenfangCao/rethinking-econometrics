...
knitr::include_graphics("~/R/teach-r-online/01-cloud/img/jonathan-borba-PZBjJ12Xv2s-unsplash.jpg")
```
]
--
.pull-right[
...
knitr::include_graphics("~/R/teach-r-online/01-cloud/img/sincerely-media-o5Key-1HzaY-unsplash.jpg")
```
]
...
.pull-left-narrow[
```{r echo=FALSE}
knitr::include_graphics("~/R/teach-r-online/01-cloud/img/cloud.png")
```
]
.pull-right-wide[
...
knitr::include_graphics("~/R/teach-r-online/01-cloud/img/rstudio-ide.png")
```
]
...
.center[
```{r echo=FALSE, out.width="80%"}
knitr::include_graphics("~/R/teach-r-online/01-cloud/img/rstudio-cloud.png")
```
]
